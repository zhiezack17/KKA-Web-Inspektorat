...
if (ctype_digit((string)$subRes1) && $subRes2 === 'rincian') {
    $GLOBALS['_sesi_route'] = true;
    $GLOBALS['_sesi_resource_sub1'] = $subRes1;
    $GLOBALS['_sesi_resource_sub2'] = $subRes3;
    $GLOBALS['subRes2'] = null;
    $GLOBALS['subRes3'] = null;
    global $subRes2, $subRes3;
    $subRes2 = null;
    $subRes3 = null;
